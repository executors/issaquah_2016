...
class executor
{
  ...
  struct impl_base
  {
    ...
    virtual impl_base* executor_transform(never_blocking_t) const = 0;
    virtual impl_base* executor_transform(possibly_blocking_t) const = 0;
    virtual impl_base* executor_transform(always_blocking_t) const = 0;
    virtual impl_base* executor_try_transform(continuation_t) const = 0;
    virtual impl_base* executor_try_transform(not_continuation_t) const = 0;
    virtual impl_base* executor_try_transform(outstanding_work_t) const = 0;
    virtual impl_base* executor_try_transform(not_outstanding_work_t) const = 0;
    virtual impl_base* executor_try_transform(bulk_sequenced_execution_t) const = 0;
    virtual impl_base* executor_try_transform(bulk_parallel_execution_t) const = 0;
    virtual impl_base* executor_try_transform(bulk_unsequenced_execution_t) const = 0;
    virtual impl_base* executor_try_transform(new_thread_execution_mapping_t) const = 0;
  ...
  struct impl : impl_base
  {
    ...
    virtual impl_base* executor_transform(never_blocking_t) const
    {
      return new impl<decltype(execution::transform(executor_, never_blocking))>(execution::transform(executor_, never_blocking));
    }

    virtual impl_base* executor_transform(possibly_blocking_t) const
    {
      return new impl<decltype(execution::transform(executor_, possibly_blocking))>(execution::transform(executor_, possibly_blocking));
    }

    virtual impl_base* executor_transform(always_blocking_t) const
    {
      return new impl<decltype(execution::transform(executor_, always_blocking))>(execution::transform(executor_, always_blocking));
    }

    virtual impl_base* executor_try_transform(continuation_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, continuation))>(execution::try_transform(executor_, continuation));
    }

    virtual impl_base* executor_try_transform(not_continuation_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, not_continuation))>(execution::try_transform(executor_, not_continuation));
    }

    virtual impl_base* executor_try_transform(outstanding_work_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, outstanding_work))>(execution::try_transform(executor_, outstanding_work));
    }

    virtual impl_base* executor_try_transform(not_outstanding_work_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, not_outstanding_work))>(execution::try_transform(executor_, not_outstanding_work));
    }

    virtual impl_base* executor_try_transform(bulk_sequenced_execution_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, bulk_sequenced_execution))>(execution::try_transform(executor_, bulk_sequenced_execution));
    }

    virtual impl_base* executor_try_transform(bulk_parallel_execution_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, bulk_parallel_execution))>(execution::try_transform(executor_, bulk_parallel_execution));
    }

    virtual impl_base* executor_try_transform(bulk_unsequenced_execution_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, bulk_unsequenced_execution))>(execution::try_transform(executor_, bulk_unsequenced_execution));
    }

    virtual impl_base* executor_try_transform(new_thread_execution_mapping_t) const
    {
      return new impl<decltype(execution::try_transform(executor_, new_thread_execution_mapping))>(execution::try_transform(executor_, new_thread_execution_mapping));
    }
...
public:
  ...
  {
    auto e2 = execution::transform(std::move(e), execution::single, execution::bulk, execution::oneway, execution::twoway);
  ...
  executor transform(oneway_t) const { return *this; }
  executor transform(twoway_t) const { return *this; }
  executor transform(single_t) const { return *this; }
  executor transform(bulk_t) const { return *this; }
  executor transform(thread_execution_mapping_t) const { return *this; }

  executor transform(never_blocking_t) const { return context_.impl_ ? context_.impl_->executor_transform(never_blocking) : context_.impl_->clone(); }
  executor transform(possibly_blocking_t) const { return context_.impl_ ? context_.impl_->executor_transform(possibly_blocking) : context_.impl_->clone(); }
  executor transform(always_blocking_t) const { return context_.impl_ ? context_.impl_->executor_transform(always_blocking) : context_.impl_->clone(); }

  friend executor try_transform(const executor& e, continuation_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(continuation) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, not_continuation_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(not_continuation) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, outstanding_work_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(outstanding_work) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, not_outstanding_work_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(not_outstanding_work) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, bulk_sequenced_execution_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(bulk_sequenced_execution) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, bulk_parallel_execution_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(bulk_parallel_execution) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, bulk_unsequenced_execution_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(bulk_unsequenced_execution) : e.get_impl()->clone(); }
  friend executor try_transform(const executor& e, new_thread_execution_mapping_t) { return e.get_impl() ? e.get_impl()->executor_try_transform(new_thread_execution_mapping) : e.get_impl()->clone(); }
