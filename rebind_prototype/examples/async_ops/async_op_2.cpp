    ...
    const CompletionExecutor& cex, CompletionHandler h)
{
  ...
  my_twoway_operation_1(tex, n, cex,
    my_twoway_operation_2_impl<decltype(execution::try_transform_executor(tex, execution::continuation)),
      decltype(execution::try_transform_executor(cex, execution::continuation)), CompletionHandler>{
        execution::try_transform_executor(tex, execution::continuation), 0, m,
        execution::try_transform_executor(cex, execution::continuation), std::move(h)});
}
