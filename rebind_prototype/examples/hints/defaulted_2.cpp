...
int main()
{
  ...
  ex2.execute([]{ std::cout << "we made it with a try_transformence\n"; });

  auto ex3 = execution::transform(pool.executor(), custom_hints::tracing{true});
  ex3.execute([]{ std::cout << "we made it again\n"; });

  auto ex4 = execution::try_transform(pool.executor(), custom_hints::tracing{true});
  ex4.execute([]{ std::cout << "we made it again with a try_transformence\n"; });
  ...
  auto ex8 = execution::try_transform(ex7, custom_hints::tracing{true});
  ex8.execute([]{ std::cout << "and again with a try_transformence\n"; });
